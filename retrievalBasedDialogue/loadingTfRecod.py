...
__desc__ : loading and forming  batches  out of tfrecord file
__date__ 03-11-2018
linktoOriginal : https://github.com/dennybritz/chatbot-retrieval/blob/master/udc_inputs.py
"""
...
def getFeatureColumn(mode):
	featureColumns = []

	## appending all the stuff which is common in both train and test 
	featureColumns.append(tf.contrib.layers.real_valued_column(
