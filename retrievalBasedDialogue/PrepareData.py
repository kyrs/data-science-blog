...
__desc__ : this file read from the data dir and create a tfrecord file for the processing 
...
tf.flags.DEFINE_string(
  "input_dir", os.path.abspath("D:\\data\\data"),
  "Input directory containing original CSV data files (default = ''D:\\data\\data'')")

tf.flags.DEFINE_string(
  "output_dir", os.path.abspath("D:\\data\\data"),
  "Output directory for TFrEcord files (default = D:\\data\\data)")
...
def write_vocabulary(vocab_processor, outfile):
	...
	with open(outfile, "w",encoding="utf8") as vocabfile:
